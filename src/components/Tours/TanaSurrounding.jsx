...
function TanaSurrounding() {
  return (
    <div className='container itineraries'>
      ...
      <div className="row">
      <div className="col price-itinerary"><button className='PriceTours btn '><MonetizationOnIcon /> Price $1000/pax</button> </div>
      ...
      <div className='row text-center '>
        ...
        <div className="col"><span className="badge text-dark"><MonetizationOnIcon /> From $1000/pax</span></div>
      ...
      <div className='my-2' id='route-tana-surrounding'>
      <iframe title='Itinerary for Tana Surrounding' src="https://www.google.com/maps/d/u/0/embed?mid=1m-ztu1FtOOted2W16CxC51_MvGrOCWE&ehbc=2E312F" width="640" height="480"></iframe>
      </div>
