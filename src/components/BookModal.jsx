...
//         <div>
//             <div>
//                 <button className="BtnBookNow btn" variant="contained" data-bs-toggle="modal" data-bs-target="#staticBackdrop"> <EventAvailableIcon />  Book Now </button>
//             </div>
...
//                             <h3 className="modal-title " id="staticBackdropLabel">Booking form - Madasafaritours</h3>
...
<Dialog open={open} onClose={handleClose} id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">

{/* <div className="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true"> */}
                {/* <div className="modal-dialog modal-dialog-centered modal-lg"> */}
                    {/* <div className="modal-content modalBookNow"> */}
                    {/* className='modalBookNow' */}
                    <DialogTitle className='modalBookNow' id="draggable-dialog-title"> Booking form - Madasafaritours </DialogTitle>
